import { Catch, ExceptionFilter, Inject, NotFoundException, LoggerService, ArgumentsHost } from '@nestjs/common';
...
export class NotFoundExceptionFilter implements ExceptionFilter {
  constructor(
    ...
    if (isApi) {
      ...
      this.loggerService.error(message, exception.stack, NotFoundExceptionFilter.name);
