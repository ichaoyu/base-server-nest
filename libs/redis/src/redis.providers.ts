 ...
 * @returns Provider对象
 */
export function createRedisClient(clientToken: InjectionToken, optionsToken: InjectionToken): Provider {
  return {
    provide: clientToken,
 ...
 * @returns Provider对象
 */
export function createRedisCluster(clusterToken: InjectionToken, optionsToken: InjectionToken): Provider {
  return {
 ...
 * @returns Provider对象
 */
export function createRedisCommonOptions(optionsToken: InjectionToken, provider: OptionsProviderRedis): Provider {
  return {
