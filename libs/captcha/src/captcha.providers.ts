...
import { CAPTCHA_MERGED_OPTIONS, CAPTCHA_OPTIONS, defaultOptions } from './captcha.constant';
...
export function createCaptchaOptions(provider: OptionsProviderCaptcha): Provider {
  return {
